package org.crazybun.codegen.test;

import org.crazybun.codegen.modules.common.annotation.UIColumn;
...
public class MyEasyCodeTest {
    ...
    private String[] paths ={
            ...
            "src/main/java/org/crazybun/codegen/demo/web/controller/",
            "src/main/java/org/crazybun/codegen/demo/service/",
            "src/main/java/org/crazybun/codegen/demo/service/impl/",
            "src/main/java/org/crazybun/codegen/demo/query/"
            */
    };
    ...
    private List<FieldVo> scanDomain(String domainBig) {
        ...
        try {
            //Class对象
            String className = "org.crazybun.codegen.domain."+domainBig;
