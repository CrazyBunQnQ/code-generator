...
import org.crazybun.codegen.utils.MyStringUtils;
import lombok.Data;
...
public class MyConfigBuilder {
    ...
    private void handlerPackage(String outputDir, Map<String,String> config) {
        ...
        // 获取包配置信息 【 ex: service -> org.crazybun.codegen.modules.service 】
        packageInfo = getPackageInfo(parentValue, moduleNameValue);

        // 生成路径信息 【 ex: service -> E:\IT_CrazyBunQnQ\code\me_workspace\demo\code-generator-api/document/upload/code\service 】
